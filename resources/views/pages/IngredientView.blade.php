            ...
            @foreach ($ingredients as $ingredient)
                <div class="ingredient-row">
                    <input type="checkbox" id="ingredient-{{ $ingredient->ingredient_id }}"
                           name="ingredient_ids[]" value="{{ $ingredient->ingredient_id }}">
                    <label for="ingredient-{{ $ingredient->ingredient_id }}" class="ingredient-label">
                        {{ $ingredient->name }}
                    </label>
                    <input type="number" name="quantities[{{ $ingredient->ingredient_id }}]"
                           placeholder="Quantity" class="quantity-input"> gr/ud
                </div>
            @endforeach
        </div>
    </div>
